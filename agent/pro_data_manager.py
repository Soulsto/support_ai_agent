"""
pro_data_manager.py - Manages fetching and updating data for professional players.

This script enriches a config file with permanent PUUIDs and then fetches
match data for a predefined list of pro players.
"""
...
from agent.riot_api import RiotAPIClient
from agent.analysis import extract_support_stats, analyze_match_timeline
...
def update_pro_player_data(player_info: dict[str, any]):
    ...
    recent_match_ids = riot_client.get_match_ids_by_puuid(player_puuid, player_region, count=50)
